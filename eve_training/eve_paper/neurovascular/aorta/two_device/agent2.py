...
def create_agent(
    ...
    q1 = eve_rl.network.QNetwork(q1_base, n_observations, n_actions)
    ...
    q2 = eve_rl.network.QNetwork(q2_base, n_observations, n_actions)
    ...
    policy = eve_rl.network.GaussianPolicy(policy_base, n_observations, n_actions)
