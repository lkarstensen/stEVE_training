...
RESULTS_FOLDER = (
    os.getcwd() + "/results/eve_paper/neurovascular/aorta/gw_only/arch_generator1"
)
...
if __name__ == "__main__":
    ...
    intervention = ArchGenerator(episodes_between_arch_change=1)
    env_train = GwOnly(intervention=intervention, mode="train", visualisation=False)
    intervention_eval = ArchGenerator(episodes_between_arch_change=1)
