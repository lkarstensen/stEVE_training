...
import eve_bench.neurovascular.aorta.guidewire_only.arch_generator
...
RESULTS_FOLDER = (
    os.getcwd() + "/results/eve_paper/neurovascular/aorta/gw_only/hyperparam_opti"
)
...
def objective(trial: optuna.trial.Trial):
    ...
    intervention = (
        eve_bench.neurovascular.aorta.guidewire_only.arch_generator.ArchGenerator(
